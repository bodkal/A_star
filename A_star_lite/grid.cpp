...
/*bool  world::slam_in_bounds(struct utils::pos point){
    return (point.x>=point.x- this->view && point.x < point.x+ this->view) && (point.y>=point.y- this->view && point.y < point.y+this->view);
}
*/
